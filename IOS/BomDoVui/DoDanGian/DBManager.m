...
-(instancetype)initWithDatabaseFilename:(NSString *)dbFilename
{
    ...
    if (self)
    {
       self.m_PathDatabase = [self GetPathData:dbFilename];
    }
...
-(void)runQuery:(const char *)query isQueryExecutable:(BOOL)queryExecutable
{
    ...
    // Open the database.
    BOOL openDatabaseResult = sqlite3_open([self.m_PathDatabase UTF8String], &sqlite3Database);
    if(openDatabaseResult == SQLITE_OK)
    {
            ...
            if (!queryExecutable){
                ...
                while(sqlite3_step(compiledStatement) == SQLITE_ROW)
                {
                    ...
                    for (int i=0; i<totalColumns; i++)
                    {
                        ...
                        //const char*abc = "Tôi là bình";
                        //char *dbDataAsChars = (char*)abc;
        ...
        else
        {
            ...
            NSLog(@"Error open file: %s", sqlite3_errmsg(sqlite3Database));
        }
