...
class PlayViewController: UIViewController
{
    ...
    func XClick(sender: UIButton)
    {
        ...
        {
        case 1:
            if PPCore.ShareInstance.m_ArrayPhoto[PPCore.ShareInstance.m_level].m_completed != PHOTO_STATUS.PHOTO_LOCK
            {
                PPCore.ShareInstance.m_level = PPCore.ShareInstance.m_level - 1
            }
