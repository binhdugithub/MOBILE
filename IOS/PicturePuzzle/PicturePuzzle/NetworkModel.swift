...
class NetWorkModel
{
    ...
    func LoadMoreApps()
    {
    let url = NSURL(string:"http://cusiki.com:8888/api/funnystories/apps")
    ...
    { (data, response, error) -> Void in
        ...
        if error == nil
        {
            ...
            do
            {
                let JSONResponse = try NSJSONSerialization.JSONObjectWithData(data!, options: []) as! NSDictionary
            ...
            {
                print("Failed to load:\(l_error.localizedDescription)")
            }
